...
class SearchableDropdown<T> extends StatefulWidget {
  ...
  final void Function(T? value)? onPop;
...
class _SearchableDropdownState<T> extends State<SearchableDropdown<T>> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child:
          widget.backgroundDecoration != null ? widget.backgroundDecoration!(buildDropDown(context, controller)) : buildDropDown(context, controller),
    );
  }
        ...
        Flexible(
          child: Card(
            ...
            child: Column(
              ...
              children: [
                if (widget.showSearch) buildSearchBar(context, controller),
                Flexible(
  ...
  Widget dropDownText(SearcableDropdownController<T> controller) {
    return ValueListenableBuilder(
      ...
      builder: (context, SearchableDropdownMenuItem<T>? selectedItem, child) =>
          selectedItem?.child ??
          (selectedItem?.label != null ? Text(selectedItem!.label, maxLines: 1, overflow: TextOverflow.fade) : widget.hintText) ??
